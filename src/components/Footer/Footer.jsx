            ...
            <section className="footer__main">
                <span className="footer__main--columns">
                    ...
                    <div className="footer__main--columns_social">
                        <button className="footer__main--columns_social-btn" onClick={
                            () => {
                ...
                <span className="footer__main--columns">
                    ...
                    <p className="footer__main--columns_links" onClick={
                        () => {
                            navigate("/about")
                        }
                    }> Order Status </p>
                ...
                <span className="footer__main--columns">
                    ...
                    <div className="footer__main--columns_gallery">
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_01").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_02").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_03").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_04").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_05").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
                        ...
                        onMouseLeave={() => {document.getElementById("overlay_06").style.display = `none`}} onClick={
                        () => {
                            navigate("/about")
                        }
                    }>
